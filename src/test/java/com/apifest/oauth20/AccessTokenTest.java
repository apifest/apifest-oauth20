...
public class AccessTokenTest {
    ...
    public void when_load_from_map_initialize_all_fields() throws Exception {
        ...
        assertEquals(accessToken.getCodeId(), "mvmxEVdjqdFr##yFdxnliZ#vTBOcsR#QGMGxa-dqGU-Z#PZjkojc_YCshPa_bvQcpmH=cq-ZGNeEzlTqxCteijq-_UBPnF=kVdsJEe=WUYWg_ptHp-VmrmelqWnfRMdolV=ibwJPMdLxkIriCEYFt#fGNzlLpgzzyT-Hoz#tkwWUGhZHuzOiruiafxOKScuaW=hYkICr");
        assertTrue(accessToken.getCreated() == 1365351985645l);
        assertEquals(accessToken.getExpiresIn(), "599");
        assertEquals(accessToken.getRefreshToken(), "197ef958a30828c2148a1f242502a9473e5de0e6e5abfb55641e972fc32850e0");
        assertEquals(accessToken.getScope(), null);
        assertEquals(accessToken.getToken(), "2a6ceee879e57fb7ef879b8be96db0c72c1ef3e42bb0e2f9746200b85edafb3c");
    ...
    @Test
    public void when_create_access_token_for_client_credentials_do_not_add_refresh_token() throws Exception {
        // WHEN
    ...
    @Test
    public void when_created_plus_expiresIn_greater_then_current_time_return_true() throws Exception {
        // GIVEN
